...
Logtextfile.Text = Logtextfile.Text + "!!! Listening for connections on tcp port(s) " + Text3.Text + vbCrLf 'Adding to the log which port it is listening for a connection on!
End Sub
...
Logtextfile.Text = Logtextfile.Text + "!!! Closing TCP port(s) " + Text3.Text + vbCrLf 'Adding to the log that we are closing the port!
End Sub

Private Sub Command3_Click()
Label4.Caption = 1
Logtextfile.Text = Logtextfile.Text + "** " + Format(Now, "General Date") + " - " + "Hard log is on" + vbCrLf
End Sub

Private Sub Command4_Click()
Label4.Caption = 2
Logtextfile.Text = Logtextfile.Text + "** " + Format(Now, "General Date") + " - " + "Soft log is on" + vbCrLf
End Sub

Private Sub Command5_Click()
Open "Log.txt" For Output As #1
    Print #1, Logtextfile.Text
Close #1
End Sub
...
Logtextfile.Text = Logtextfile.Text + "** " + Format(Now, "General Date") + " - " + Winsock(Index).RemoteHostIP + ":" + Winsock(Index).Tag + " Connection Attempted!" + vbCrLf 'Adding to the log that the intruder *his ip* and *which port* has made a connection attempt!
